  ...
  async function getDetails() {
    ...
    try {
      const detailsRes = await axios.get(
        `https://filman-api.awfulworld.space/v1/details?cookies=${await AsyncStorage.getItem(
          'user/cookies',
    ...
    <View
      ...
      <ImageBackground
        style={{
          ...
          width: '100%',
          height: '100%',
          bottom: bottomPanelY * 2,
        }}
        source={{uri: film.imageUrl}}></ImageBackground>
      <LinearGradient
        colors={[
          'transparent',
          'rgba(0,0,0,0.6)',
          ...
          <View>
            {isLoading ? (
              ...
              <View style={{marginTop: 4}}>
                ...
                {filmDetails.links
                  .sort((a, b) =>
                    b.qualityVersion.localeCompare(a.qualityVersion),
                  )
