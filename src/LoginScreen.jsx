    ...
    return (
      <View
        ...
        <View
          ...
          <ActivityIndicator size={60} animating={true} color={'#FC3627'} />
          <Text style={{color: 'white', fontSize: 16, top: 20}}>
            {loginStatus}
          </Text>
        </View>
      </View>
    ...
    <View
      ...
      <View
        ...
        <View style={{flexDirection: 'row', marginBottom: 45, top: -35}}>
          ...
          <Text style={{color: '#FC3627', fontWeight: 'bold', fontSize: 50}}>
            in
          </Text>
        </View>
          ...
          {error.map(err => {
            return (
              <Text
                ...
                type={'error'}
                style={{color: '#FC3627', alignSelf: 'center', fontSize: 14}}>
                {err}
              </Text>
            );
          })}
        ...
        <View>
          <Button
            ...
            onPress={async () => {
              let err = [];
              if (!login || !password) err.push('Fill in credentials');
              setError(err);
            ...
            onVerify={async token => {
              ...
              try {
                const loginRes = await axios.post(
                  'https://filman-api.awfulworld.space/v1/login',
                  {
                    username: login,
                    password,
                    captchaToken: token,
